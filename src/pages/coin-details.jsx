      ...
      { !loading && !error && (
        <>
          ...
          <div className="coin-details-info">
            ...
            <h4>All-time High: ${ coin.market_data.ath.usd.toLocaleString() } on { ' ' } { new Date(coin.market_data.ath_date.usd).toDateString() }</h4>
            <h4>All-time Low: ${ coin.market_data.atl.usd.toLocaleString() } on { ' ' } { new Date(coin.market_data.atl.usd).toLocaleDateString()}</h4>
          ...
          <div className="coin-details-links">
            ...
            { coin.links.blockchain_site[0] && (
              <p>
                🧩 { ' ' }
                <a href={coin.links.blockchain_site[0]} target="_blank" rel="noopenner noreferrer">Blockchain Explorer</a>
              </p>
            ) }
